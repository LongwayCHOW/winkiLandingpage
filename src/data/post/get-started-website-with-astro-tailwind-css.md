...
author: John Smith
title: Get started with Winki to create a website using Astro and Tailwind CSS
excerpt: Start your web journey with Winki – harness Astro and Tailwind CSS for a stunning site. Explore our guide now.
...
draft: true
metadata:
  canonical: https://winki.win/get-started-website-with-astro-tailwind-css
---
